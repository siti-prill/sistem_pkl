    ...
    <div class="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-xl p-4 mb-6">
        <div class="flex items-center">
            ...
            <p class="text-sm text-teal-800 dark:text-teal-200">
                Pilih siswa untuk mengisi penilaian sesuai template dari sekolah. Nilai akan langsung terlihat oleh guru pembimbing dan siswa.
            </p>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($penempatans as $index => $penempatan)
                        @php
                            $sudahDinilai = \App\Models\MonitoringNilai::where('penempatan_id', $penempatan->id)
