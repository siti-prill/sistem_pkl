...
@section('title', 'Input Penilaian - ' . $penempatan->siswa->nama_siswa)

@section('content')
<div class="animate-fadeIn">
    <div class="flex items-center mb-6">
        <a href="{{ route('industri.penilaian.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mr-4">
            <i class="fas fa-arrow-left text-xl"></i>
        </a>
        <div class="flex-1">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">
                <i class="fas fa-clipboard-check mr-2 text-teal-500"></i> DAFTAR NILAI PRAKTIK KERJA LAPANGAN
            </h2>
        </div>
    ...
    <form action="{{ route('industri.penilaian.store', $penempatan->id) }}" method="POST" id="formPenilaian">
        @csrf
                                ...
                                <tr>
                                    ...
                                    <td class="border border-gray-300 dark:border-gray-600 px-2 py-1">
                                        <input type="number" name="{{ $nilaiKey }}"
                                            class="w-full text-center border-0 bg-transparent focus:ring-1 focus:ring-teal-500 rounded"
                                            min="0" max="100"
                                            value="{{ $oldNilai }}"
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="{{ route('industri.penilaian.index') }}" class="btn-danger flex-1 text-center">
