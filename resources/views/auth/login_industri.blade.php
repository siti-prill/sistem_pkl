...
<head>
    ...
    <title>Login Industri - Sistem PKL</title>
...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login.industri') }}">
                @csrf
                ...
                <div class="text-center mt-2">
                    <a href="{{ route('landing') }}" class="text-decoration-none"
                        style="color: #0d9488; font-weight: 500; font-size: 14px;">
