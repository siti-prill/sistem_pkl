...
<div class="animate-fadeIn">
    <div class="flex items-center mb-6">
        <a href="{{ route('admin.guru.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mr-4">
            <i class="fas fa-arrow-left text-xl"></i>
        </a>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">
            <i class="fas fa-plus-circle mr-2 text-indigo-500"></i> Tambah Guru
        </h2>
    </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="nip" value="{{ old('nip') }}" 
                           class="form-input" placeholder="Masukkan NIP" required>
                    @error('nip')
                ...
                <div>
                    ...
                    <input type="text" name="no_telepon" value="{{ old('no_telepon') }}" 
                           class="form-input" placeholder="Masukkan no telepon">
                    @error('no_telepon')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
