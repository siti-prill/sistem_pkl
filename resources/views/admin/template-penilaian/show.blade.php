    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 max-w-2xl">
        <div class="space-y-4">
                ...
                <div>
                    ...
                    <p>
                        @if($template->kategori === 'kejuruan')
                            <span class="badge-info">A. Aspek Kejuruan</span>
                        @else
                            <span class="badge-warning">B. Aspek Sikap</span>
                        @endif
                    </p>
                </div>
                <div>
                    ...
                    <p>
                        @if($template->tipe === 'komponen')
                            <span class="badge-secondary">Komponen</span>
                        @else
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('admin.template-penilaian.edit', $template) }}" class="btn-warning flex-1 text-center">
