            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_aspek" value="{{ old('nama_aspek') }}"
                        class="form-input" placeholder="Contoh: Disiplin, Kompetensi Dasar 1, dll" required>
                    @error('nama_aspek')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="2" class="form-input"
                ...
                <div>
                    ...
                    <textarea name="instruksi" rows="2" class="form-input"
